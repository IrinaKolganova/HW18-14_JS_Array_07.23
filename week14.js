...
const myInformation = ['Irina', 18, 'may', 'taurus']
...
const squaredNumbers = numbers.map((item) => { return item * item; });
...
const russianCities2 = ['Санкт-Петербург', 'Москва', 'Екатеринбург', ...russianCities];
console.log(russianCities2);
//ВОПРОС: Но в данной ситуации я создала новый массив... А как сделать так, чтобы с помощью spread изменить имеющийся?
...
const newNumbers = numbers.filter(function filterEvenNumbers(item) {
    if (item % 2 == 0) { return true }
    return false
});
console.log(newNumbers);
//Верно ли я здесь поняла задание? Или первостепенно должна была быть функция? Поправь пожалуйста, если я сделала неверно

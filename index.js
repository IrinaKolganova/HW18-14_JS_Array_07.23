...
if (one >= 80) { console.log("A"); }
else if (one >= 60 && one < 80) { console.log("B"); }
else if (one >= 40 && one < 60) { console.log("C"); }
else if (one >= 20 && one < 40) { console.log("D"); }
else { console.log("E"); }
